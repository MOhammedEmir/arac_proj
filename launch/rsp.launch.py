...
def generate_launch_description():
    beetle_desc_dir = FindPackageShare(package='arac_proj').find('arac_proj')
    robot_description = xacro.process_file(os.path.join(beetle_desc_dir, 'description/robot.urdf.xacro')).toxml()
